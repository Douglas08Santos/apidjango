    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_voluntary', models.BooleanField(default=False, verbose_name='Voluntario')),
                ('is_accountable', models.BooleanField(default=False, verbose_name='Responsavel')),
                ('national_id', models.CharField(blank=True, max_length=14, null=True, unique=True, verbose_name='CPF')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.address', verbose_name='Endereco')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.institution')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.institution')),
                ('voluntary', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.voluntary')),
            ],
            options={
